...
const ReceiptsReport = () => {
  ...
  return (
    <div>
      <div>
        <BackButton />
        <h1 className="fw-bold h4 mt-1">Receipts report</h1>
      </div>
          ...
          >
            {({ handleSubmit }) => (
              <Form className="text-start" noValidate onSubmit={handleSubmit}>
                <Row>
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="ReceiptsReportFormFromDate">
                  ...
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="ReceiptsReportFormToDate">
      ...
      <Table
        ...
        customHeader={
          <CustomTableHeader
            ...
            total={receiptsReportData.length}
          />
        }
        showTotal={false}
        shadow={false}
        data={receiptsReportData}
        columns={columns}
        total={receiptsReportData.length}
      />
    </div>
