...
const FixedAssetsReports = () => {
  ...
  return (
    <div>
      <div>
        <BackButton />
        <h1 className="fw-bold h4 mt-1">Fixed assets report</h1>
      </div>
          ...
          >
            {({ handleSubmit }) => (
              <Form className="text-start" noValidate onSubmit={handleSubmit}>
                <Row>
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="FixedAssetsReportsFormFromDate">
                  ...
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="FixedAssetsReportsFormToDate">
      ...
      <Table
        ...
        customHeader={
          <CustomTableHeader
            ...
            total={fixedAssetsReportsData.length}
          />
        }
        showTotal={false}
        shadow={false}
        data={fixedAssetsReportsData}
        columns={columns}
        total={fixedAssetsReportsData.length}
      />
    </div>
