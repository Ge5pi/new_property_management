...
const LeasesReport = () => {
  ...
  return (
    <div>
      <div>
        <BackButton />
        <h1 className="fw-bold h4 mt-1">Leases report</h1>
      </div>
          ...
          >
            {({ handleSubmit }) => (
              <Form className="text-start" noValidate onSubmit={handleSubmit}>
                <Row>
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="LeasesReportFormFromDate">
                  ...
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="LeasesReportFormToDate">
      ...
      <Table
        ...
        customHeader={
          <CustomTableHeader
            ...
            total={leasesReportData.length}
          />
        }
        showTotal={false}
        shadow={false}
        data={leasesReportData}
        columns={columns}
        total={leasesReportData.length}
      />
    </div>
