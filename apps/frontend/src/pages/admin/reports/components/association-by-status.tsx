...
const AssociationByStatus = () => {
  const associationByStatusData = [
    {
      property: {
        title: 'Property 1',
        subtitle: 'Address 1',
  ...
  return (
    <div>
      <div>
        <BackButton />
        <h1 className="fw-bold h4 mt-1">Associations by Status</h1>
      </div>
          ...
          >
            {({ handleSubmit }) => (
              <Form className="text-start" noValidate onSubmit={handleSubmit}>
                <Row>
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="AssociationByStatusFormFromDate">
                  ...
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="AssociationByStatusFormToDate">
                  ...
                  <Col sm={3} lg={2}>
                    <CustomSelect
                      labelText="status"
                      name="status"
                      controlId="AssociationByStatusFormStatus"
                      options={[]}
                      searchable
                      classNames={{
      ...
      <Table
        ...
        customHeader={
          <CustomTableHeader
            ...
            total={associationByStatusData.length}
          />
        }
        showTotal={false}
        shadow={false}
        data={associationByStatusData}
        columns={columns}
        total={associationByStatusData.length}
      />
    </div>
...
export default AssociationByStatus;
