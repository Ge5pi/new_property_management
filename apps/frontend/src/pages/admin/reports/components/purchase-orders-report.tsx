...
const PurchaseOrdersReport = () => {
  const purchaseOrdersReportData = [
    {
      unit: {
        title: 'Unit 1',
        subtitle: 'Address 1',
  ...
  return (
    <div>
      <div>
        <BackButton />
        <h1 className="fw-bold h4 mt-1">Purchase orders report</h1>
      </div>
          ...
          >
            {({ handleSubmit }) => (
              <Form className="text-start" noValidate onSubmit={handleSubmit}>
                <Row>
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="purchaseOrdersReportFormFromDate">
                  ...
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="purchaseOrdersReportFormToDate">
      ...
      <Table
        ...
        customHeader={
          <CustomTableHeader
            ...
            total={purchaseOrdersReportData.length}
          />
        }
        showTotal={false}
        shadow={false}
        data={purchaseOrdersReportData}
        columns={columns}
        total={purchaseOrdersReportData.length}
      />
    </div>
