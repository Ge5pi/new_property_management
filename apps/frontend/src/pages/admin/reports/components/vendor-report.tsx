...
const VendorReport = () => {
  ...
  return (
    <div>
      <div>
        <BackButton />
        <h1 className="fw-bold h4 mt-1">Vendor report</h1>
      </div>
          ...
          >
            {({ handleSubmit }) => (
              <Form className="text-start" noValidate onSubmit={handleSubmit}>
                <Row>
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="VendorReportFormFromDate">
                  ...
                  <Col sm={3} lg={2}>
                    <Form.Group className="mb-4" controlId="VendorReportFormToDate">
