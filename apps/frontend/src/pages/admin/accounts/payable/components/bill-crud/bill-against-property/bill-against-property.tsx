        ...
        {({ errors, touched, setFieldValue, setFieldTouched }) => (
          <>
            <Stack className="justify-content-between" direction="horizontal">
              <div>
                <BackButton />
                <h1 className="fw-bold h4 mt-1">Utility Bill ID-213</h1>
              </div>
              <div>
            ...
            <Card className="border-0 p-4 page-section mb-3">
              ...
              <Card.Body className="p-0 mt-4">
                <Row className="gx-sm-4 gx-0">
                  <Col sm={6} md={4}>
                    <CustomSelect
                      ...
                      name={property.name}
                      controlId="BillAgainstPropertyFormProperty"
                  ...
                  <Col sm={6} md={3}>
                    <CustomSelect
                      labelText="Utility"
                      onSelectChange={value => {
                        setFieldValue(utility.name, value);
                        setFieldTouched(utility.name, true);
                      }}
                      onBlurChange={() => {
                        setFieldTouched(utility.name, true);
                      }}
                      name={utility.name}
                      controlId="BillAgainstPropertyFormUtility"
                      options={[{ value: '1', label: 'Option 1' }]}
                      classNames={{
                        labelClass: 'popup-form-labels',
                        wrapperClass: 'mb-4',
                      }}
                      isInvalid={!!(touched.utility && errors && errors.utility)}
                      isValid={!!(touched.utility && errors && !errors.utility)}
                      error={errors && errors.utility}
                    />
                  </Col>
                  <Col sm={6} md={2}>
                    <Form.Group className="mb-4" controlId="BillAgainstPropertyFormBillDate">
                  ...
                  <Col sm={6} md={2}>
                    <Form.Group className="mb-4" controlId="BillAgainstPropertyFormDueDate">
                ...
                <p className="fw-bold m-0 my-3 text-primary">Consumptions</p>

                <Row className="gx-sm-4 gx-0">
                  <Col sm={6} md={2}>
                    <Form.Group className="mb-4" controlId="RecurringFormFrom">
                      <Form.Label className="form-label-md">From</Form.Label>
                      <Field
                        name={from.name}
                        type="text"
                        className={clsx(
                          'form-control',
                          touched?.from && (errors && errors.from ? 'is-invalid' : 'is-valid')
                        )}
                        placeholder="Title"
                      />
                  ...
                  <Col sm={6} md={2}>
                    <Form.Group className="mb-4" controlId="RecurringFormTo">
                      <Form.Label className="form-label-md">To</Form.Label>
                      <Field
                        name={to.name}
                        type="text"
                        className={clsx(
                          'form-control',
                          touched?.to && (errors && errors.to ? 'is-invalid' : 'is-valid')
                        )}
                        placeholder="Title"
                      />
...
export default BillAgainstProperty;
