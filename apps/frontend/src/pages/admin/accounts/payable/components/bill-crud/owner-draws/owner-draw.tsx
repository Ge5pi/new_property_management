...
const OwnerDraw = () => {
  ...
  const { notes, total_amount, reference_no, gl_account, bill_date, memo_on_check, property, remarks, owner } =
    formFields;
                ...
                <Row className="gx-sm-4 gx-0">
                  <Col sm={6} md={4}>
                    <CustomSelect
                      ...
                      name={property.name}
                      controlId="OwnerDrawFormProperty"
                  ...
                  <Col sm={6} md={3}>
                    <CustomSelect
                      ...
                      onSelectChange={value => {
                        setFieldValue(owner.name, value);
                        setFieldTouched(owner.name, true);
                      }}
                      onBlurChange={() => {
                        setFieldTouched(owner.name, true);
                      }}
                      name={owner.name}
                      controlId="OwnerDrawFormOwner"
                      options={[{ value: '1', label: 'Option 1' }]}
                      classNames={{
                        labelClass: 'popup-form-labels',
                        wrapperClass: 'mb-4',
                      }}
                      isInvalid={!!(touched.owner && errors && errors.owner)}
                      isValid={!!(touched.owner && errors && !errors.owner)}
